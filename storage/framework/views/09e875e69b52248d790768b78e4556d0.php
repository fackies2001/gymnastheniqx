<?php $__env->startSection('adminlte_head'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('sanctum_token')): ?>
        <meta name="api-token" content="<?php echo e(session('sanctum_token')); ?>">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check() && !session()->has('pin_verified')): ?>
            ...
            <div class="modal-content"
                ...
                <div class="modal-header"
                    ...
                    <h5 class="modal-title text-white font-weight-bold">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->pin): ?>
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <form id="pincodeForm" method="POST" action="<?php echo e(route('user.verify.pin')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/pincode_LOCKED.js'); ?>
    ...
    <script>
        $(document).ready(function() {
            <?php if(!session()->has('pin_verified')): ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\inventoryyy\resources\views/layouts/adminlte.blade.php ENDPATH**/ ?>