                        ...
                        <tr>
                            ...
                            <td class="no-print">
                                @if ($order->status == 'Pending')
                                    ...
                                    @else
                                        {{-- ✅ Staff/Manager see this (not clickable) --}}
...
{{-- @push('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // ✅ INITIALIZE DATATABLE - Pending orders on top
            ...
            var table = $('#retailerTable').DataTable({
                ...
                "order": [
                    [5, "asc"]
                ], // Sort by Action column (Pending first due to badge text)
                "columnDefs": [{
                    "targets": 5,
                    "type": "string"
                }]
            ...
            // ✅ CLICK PENDING BADGE TO OPEN MODAL (Event Delegation for DataTables)
            ...
            $('#btn-approve-order').on('click', function() {
                ...
                Swal.fire({
                    title: 'Approve Order?',
                    text: 'This will update the inventory and record the sale.',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#28a745',
