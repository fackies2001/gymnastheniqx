<?php $__env->startSection('subtitle', 'Serialized Products'); ?>
<?php $__env->startSection('content_header_title', 'Products'); ?>
<?php $__env->startSection('content_header_subtitle', 'Serialized Products'); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        $(document).ready(function() {
            let token = "<?php echo e(session('sanctum_token')); ?>";
            ...
            let table = $('#summary_table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "<?php echo e(route('serialized_products.indexTable')); ?>",
                    type: 'GET',
                    headers: {
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\inventoryyy\resources\views/serialized_products/_index.blade.php ENDPATH**/ ?>