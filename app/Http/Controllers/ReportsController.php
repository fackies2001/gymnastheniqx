        ...
        try {
            ...
            if (!$type || $type === 'received') {
                try {
                    ...
                    \Log::error("PR Section Error: " . $e->getMessage());
                }
                ...
                try {
                    ...
                    foreach ($purchaseOrders as $po) {
                        ...
                        $data[] = [
                            ...
                            'traceability' => '<small><strong>Type:</strong> Purchase Order<br><strong>Supplier:</strong> ' . ($po->supplier->name ?? 'N/A') . '<br><strong>Date:</strong> ' . $createdDate . '</small>',
                            'quantity' => '-',
                            'image' => null,
                            'status' => 'Received'
                        ];
                    ...
                    \Log::error("PO Section Error: " . $e->getMessage());
                }
                ...
                try {
                    ...
                    \Log::error("SP Section Error: " . $e->getMessage());
                }
            }
