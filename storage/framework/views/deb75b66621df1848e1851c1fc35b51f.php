<?php $__env->startSection('subtitle', 'Warehouse'); ?>
<?php $__env->startSection('content_header_title', 'Warehouse'); ?>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($warehouse->assignee); ?></td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-success edit-warehouse" data-toggle="modal"
                                            data-target="#warehouseModal" data-id="<?php echo e($warehouse->id); ?>"
                                            data-name="<?php echo e($warehouse->name); ?>" data-email="<?php echo e($warehouse->email); ?>"
                                            data-phone="<?php echo e($warehouse->phone); ?>" data-address="<?php echo e($warehouse->address); ?>"
                                            data-assignee="<?php echo e($warehouse->assignee); ?>">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>
                                        <button class="btn btn-sm btn-danger delete-warehouse"
                                            data-id="<?php echo e($warehouse->id); ?>" data-name="<?php echo e($warehouse->name); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createwarehouseSubmit').off('click').on('click', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('warehouse.store')); ?>",
                    type: 'POST',
                    data: data,
                    dataType: 'json',
            ...
            $('#updateWarehouseSubmit').off('click').on('click', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('warehouse.update')); ?>",
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    success: function(res) {
            ...
            $(document).on('click', '.delete-warehouse', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('warehouse.delete')); ?>",
                            type: 'DELETE',
                            data: {
                                _token: $('meta[name="csrf-token"]').attr('content'),
                                id: warehouseId
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\inventoryyy\resources\views/warehouse/index.blade.php ENDPATH**/ ?>