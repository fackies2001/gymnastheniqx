...
@push('js')
    ...
    //         @if (session('show_pin_modal'))
    //             console.log('✅ PIN Modal Session Detected!');
    //             console.log('PIN Mode:', '{{ session('pin_mode') }}');
    //             console.log('PIN Verified:', {{ session('pin_verified') ? 'true' : 'false' }});
    ...
    //                     console.log('✅ Modal.show() executed');
    //                 } else {
    //                     console.error('❌ ERROR: #pincodeModal not found in DOM!');
    //                 }
    //             }, 500);

    //             // ✅ Prevent closing
    //             $(document).on('hide.bs.modal', '#pincodeModal', function(e) {
    //                 console.log('⚠️ Modal close attempt - BLOCKED');
    //                 e.preventDefault();
    //                 e.stopPropagation();
    //                 return false;
    //             });
    ...
    //             });
    //         @else
    //             console.log('ℹ️ No PIN modal session found');
    //         @endif
    ...
    //         if (activeFilter === 'custom') $('#customDateRange').show();
    ...
    //                 e = $('#endDate').val();
    //             if (s && e) applyDateFilter('custom', s, e);
