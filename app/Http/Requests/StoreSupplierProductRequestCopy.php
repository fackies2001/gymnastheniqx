    ...
    public function rules(): array
    {
        if (auth()->user()->is_student) {
            return [
                ...
                'category_id' => 'required|integer|exists:category,id', // ✅ FIXED: category_id
                'name' => 'required|string|max:255',
                'sku' => 'nullable|string|max:255|unique:supplier_product,supplier_sku',
                'cost_price' => 'required|numeric|min:0', // ✅ FIXED: required
                'barcode' => 'required|string|max:255', // ✅ FIXED: required
                'is_consumable' => 'nullable|boolean',
            ];
        } else {
            return [
                // ✅ FIXED: Use category_id instead of category string
