    ...
    <div id="scanContainer" data-po-id="{{ $po->id }}">
        ...
        <div class="top-info-bar">
            <div class="info-group">
                ...
                <strong class="info-value">{{ $po->po_number }}</strong>
            </div>
            <div class="info-divider"></div>
            <div class="info-group">
                <span class="info-label">Supplier:</span>
                <span class="info-value">{{ $po->supplier->name ?? 'N/A' }}</span>
            </div>
            <div class="info-divider"></div>
            <div class="info-group">
                <span class="info-label">Delivery Date:</span>
                <span class="info-value">{{ $po->delivery_date ? $po->delivery_date->format('M d, Y') : 'N/A' }}</span>
            </div>
            <div class="info-divider"></div>
            <div class="info-group">
                <span class="info-label">Total:</span>
                <strong class="info-value text-success">₱{{ number_format($po->grand_total ?? 0, 2) }}</strong>
            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-4">
                        <div class="stat-card text-center">
                            ...
                            <div class="stat-number" id="totalOrderedDisplay">{{ $po->items->sum('quantity_ordered') }}
                            </div>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-white">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <span class="badge badge-info">{{ $po->items->count() }} products</span>
                        </div>
                    </div>
                    <div class="card-body p-0">
                                        ...
                                        <tr class="po-item-row" data-product-id="{{ $item->product_id }}"
                                            ...
                                            <td>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar" id="progress-{{ $item->product_id }}"
                                                        style="width: 0%"></div>
                                                </div>
                                                <small class="text-muted d-flex justify-content-between mt-1">
                                                    <span
                                                        id="pcount-{{ $item->product_id }}">0/{{ $item->quantity_ordered }}</span>
                                                    <span id="ppct-{{ $item->product_id }}">0%</span>
                                                </small>
                                            </td>
                                        </tr>
                                    @endforeach
