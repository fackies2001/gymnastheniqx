        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span class="ms-2 text-sm text-violet-600 dark:text-violet-400"><?php echo e(__('Remember me')); ?></span>
            </label>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\inventoryyy\resources\views/auth/login.blade.php ENDPATH**/ ?>